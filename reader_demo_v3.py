...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        bookurl = QUrl.fromLocalFile(mydir + '/bibi/index.html')
        bookurl.setQuery('book=alice.epub')
    ...
    def readsettings(self):
        settings = QSettings('Sigil','BibiReader')
...
app.setApplicationName("Bibi Reader Demo")
